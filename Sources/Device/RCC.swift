...
public struct RCC {
    ...
    public var dkcfgr1: Register<DKCFGR1>

    /// dedicated clocks configuration register
    @RegisterBlock(offset: 0x90)
    public var dkcfgr2: Register<DKCFGR2>
}
...
extension RCC {
    ...
    public struct PLLCFGR {
        ...
        public var pllq3: PLLQ3

        /// Main PLL (PLL) division factor for USB OTG FS, SDIO and random number generator clocks
        @ReadWrite(bits: 26..<27)
        public var pllq2: PLLQ2

        /// Main PLL (PLL) division factor for USB OTG FS, SDIO and random number generator clocks
        @ReadWrite(bits: 25..<26)
        public var pllq1: PLLQ1

        /// Main PLL (PLL) division factor for USB OTG FS, SDIO and random number generator clocks
        @ReadWrite(bits: 24..<25)
        public var pllq0: PLLQ0
        ...
        public var pllp1: PLLP1

        /// Main PLL (PLL) division factor for main system clock
        @ReadWrite(bits: 16..<17)
        public var pllp0: PLLP0

        /// Main PLL (PLL) multiplication factor for VCO
        @ReadWrite(bits: 14..<15)
        public var plln8: PLLN8

        /// Main PLL (PLL) multiplication factor for VCO
        @ReadWrite(bits: 13..<14)
        public var plln7: PLLN7

        /// Main PLL (PLL) multiplication factor for VCO
        @ReadWrite(bits: 12..<13)
        public var plln6: PLLN6

        /// Main PLL (PLL) multiplication factor for VCO
        @ReadWrite(bits: 11..<12)
        public var plln5: PLLN5

        /// Main PLL (PLL) multiplication factor for VCO
        @ReadWrite(bits: 10..<11)
        public var plln4: PLLN4

        /// Main PLL (PLL) multiplication factor for VCO
        @ReadWrite(bits: 9..<10)
        public var plln3: PLLN3

        /// Main PLL (PLL) multiplication factor for VCO
        @ReadWrite(bits: 8..<9)
        public var plln2: PLLN2

        /// Main PLL (PLL) multiplication factor for VCO
        @ReadWrite(bits: 7..<8)
        public var plln1: PLLN1

        /// Main PLL (PLL) multiplication factor for VCO
        @ReadWrite(bits: 6..<7)
        public var plln0: PLLN0

        /// Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
        @ReadWrite(bits: 5..<6)
        public var pllm5: PLLM5

        /// Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
        @ReadWrite(bits: 4..<5)
        public var pllm4: PLLM4

        /// Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
        @ReadWrite(bits: 3..<4)
        public var pllm3: PLLM3

        /// Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
        @ReadWrite(bits: 2..<3)
        public var pllm2: PLLM2

        /// Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
        @ReadWrite(bits: 1..<2)
        public var pllm1: PLLM1

        /// Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
        @ReadWrite(bits: 0..<1)
        public var pllm0: PLLM0
    }
    ...
    public struct CFGR {
        ...
        @ReadOnly(bits: 3..<4)
        public var sws1: SWS1

        /// System clock switch status
        @ReadOnly(bits: 2..<3)
        public var sws0: SWS0
    ...
    public struct APB1RSTR {
        ...
        /// USART 2 reset
        @ReadWrite(bits: 17..<18)
        public var uart2rst: UART2RST

        /// USART 3 reset
        @ReadWrite(bits: 18..<19)
        public var uart3rst: UART3RST
    ...
    public struct AHB1ENR {
        ...
        @ReadWrite(bits: 20..<21)
        public var ccmdataramen: CCMDATARAMEN
    ...
    public struct APB1ENR {
        ...
        /// UART7 clock enable
        @ReadWrite(bits: 30..<31)
        public var uart7enr: UART7ENR

        /// UART8 clock enable
        @ReadWrite(bits: 31..<32)
        public var uart8enr: UART8ENR
    ...
    public struct APB2ENR {
        ...
        /// SPI5 clock enable
        @ReadWrite(bits: 20..<21)
        public var spi5enr: SPI5ENR

        /// SPI6 clock enable
        @ReadWrite(bits: 21..<22)
        public var spi6enr: SPI6ENR
    ...
    public struct BDCR {
        ...
        @ReadWrite(bits: 9..<10)
        public var rtcsel1: RTCSEL1

        /// RTC clock source selection
        @ReadWrite(bits: 8..<9)
        public var rtcsel0: RTCSEL0
    ...
    /// dedicated clocks configuration register
    @Register(bitWidth: 32)
    public struct DKCFGR1 {
        /// PLLI2S division factor for SAI1 clock
        @ReadWrite(bits: 0..<5)
        public var plli2sdiv: PLLI2SDIV
